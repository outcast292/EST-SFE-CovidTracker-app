...
public class registerActivity extends AppCompatActivity implements
    ...
    public void onStart() {
        ...
        if (mVerificationInProgress && validatePhoneNumber()) {
            startPhoneNumberVerification("+212" + mPhoneNumberField.getEditText().getText().toString());
        }
    }
    ...
    private boolean validatePhoneNumber() {
        ...
        String phoneNumber = "+212" + mPhoneNumberField.getEditText().getText().toString();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonResend:
                resendVerificationCode("+212" + mPhoneNumberField.getEditText().getText().toString(), mResendToken);
                break;
        }
    }
}